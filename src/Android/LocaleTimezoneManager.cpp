...
CarrierConfig LocaleTimezoneManager::getCarrierForLocation(const QString& country, const QString& region, const QString& seed) const {
    ...
    static const QMap<QString, QVector<CarrierEntry>> COUNTRY_CARRIERS = {
        {"US", {{"T-Mobile", "TMO", "310", "260", "LTE"},
                ...
                {"Verizon", "VZ", "310", "004", "5G"},
                {"T-Mobile", "TMO", "312", "250", "5G"},
                {"Metro by T-Mobile", "Metro", "311", "660", "LTE"},
                {"AT&T FirstNet", "FirstNet", "313", "100", "LTE"}}},
        {"GB", {{"EE", "EE", "234", "33", "5G"},
                {"O2", "O2", "234", "10", "LTE"},
        ...
        {"IN", {{"Jio", "JIO", "405", "874", "4G"},
                ...
                {"BSNL", "BSNL", "404", "34", "4G"},
                {"Vi", "VI", "405", "67", "4G"},
                {"Airtel", "AIR", "404", "02", "4G"},
                {"Airtel", "AIR", "405", "51", "4G"}}},
        ...
        {"CN", {{"China Mobile", "CMCC", "460", "00", "5G"},
                ...
                {"China Broadnet", "Broadnet", "460", "15", "LTE"},
                {"China Telecom", "CT", "460", "11", "LTE"},
                {"China Unicom", "CUC", "460", "09", "LTE"}}},
        ...
        {"CA", {{"Rogers", "Rogers", "302", "720", "5G"},
                ...
                {"Fido", "Fido", "302", "370", "LTE"},
                {"Freedom Mobile", "Freedom", "302", "490", "LTE"},
                {"Videotron", "Videotron", "302", "500", "LTE"},
                {"SaskTel", "SaskTel", "302", "680", "LTE"},
                {"Eastlink", "Eastlink", "302", "270", "LTE"},
                {"Public Mobile", "Public", "302", "760", "LTE"}}},
        {"BR", {{"Vivo", "Vivo", "724", "06", "4G"},
                {"Claro BR", "Claro", "724", "05", "4G"},
                {"TIM BR", "TIM", "724", "02", "4G"},
                {"Vivo", "Vivo", "724", "10", "4G"},
                {"Claro BR", "Claro", "724", "38", "4G"},
                {"Algar Telecom", "Algar", "724", "32", "4G"}}},
        {"RU", {{"MTS", "MTS", "250", "01", "LTE"},
                {"MegaFon", "MGF", "250", "02", "LTE"},
                {"Beeline", "BEE", "250", "99", "LTE"},
                {"Tele2 RU", "T2", "250", "20", "LTE"},
                {"Yota", "Yota", "250", "11", "LTE"},
                {"MOTIV", "MOTIV", "250", "35", "LTE"}}},
        {"AE", {{"Etisalat", "etisalat", "424", "02", "5G"},
                {"du", "du", "424", "03", "LTE"}}},
        {"SG", {{"Singtel", "Singtel", "525", "01", "5G"},
                {"StarHub", "StarHub", "525", "05", "LTE"},
                {"M1", "M1", "525", "03", "LTE"},
                {"SIMBA", "SIMBA", "525", "10", "LTE"}}},
        ...
        {"CO", {{"Claro Colombia", "Claro", "732", "101", "4G"},
                ...
                {"Tigo", "Tigo", "732", "103", "4G"},
                {"WOM", "WOM", "732", "360", "4G"},
                {"Avantel", "Avantel", "732", "130", "4G"}}},
        {"PE", {{"Movistar Peru", "Movistar", "716", "06", "4G"},
                {"Claro PE", "Claro", "716", "10", "4G"},
                {"Entel PE", "Entel", "716", "17", "4G"},
                {"Bitel", "Bitel", "716", "15", "4G"},
                {"Entel PE", "Entel", "716", "07", "4G"}}},
    };
